  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-auth-auth-module"], {
    ...
    function k3(module, __webpack_exports__, __webpack_require__) {
      ...
      function RegistrationComponent_ng_container_7_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "Los datos est\xE1n incorrectos");
      ...
      function RegistrationComponent_ng_container_37_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, " Las contrase\xF1as no coinciden. ");
      ...
      RegistrationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function RegistrationComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](32, "Confirmar Contrase\xF1a");
    ...
    function n5F(module, __webpack_exports__, __webpack_require__) {
      ...
      function LoginComponent_ng_container_7_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, " y contrase\xF1a ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, " a continuaci\xF3n. ");
      ...
      function LoginComponent_ng_container_8_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "Los datos de inicio de sesi\xF3n son incorrectos");
      ...
      var _c3 = "El correo electr\xF3nico debe tener al menos 3 s\xEDmbolos";
      ...
      var _c5 = "El correo electr\xF3nico debe tener un m\xE1ximo de 250 s\xEDmbolos";
      ...
      var _c7 = function _c7(a2) {
        return {
          validation: "required",
          message: "Se requiere contrase\xF1a",
          control: a2
        };
      };
      ...
      var _c8 = function _c8(a2) {
        return {
          validation: "minlength",
          message: "La contrase\xF1a debe tener al menos 3 s\xEDmbolos",
          control: a2
        };
      };

      var _c9 = "La contrase\xF1a debe tener un m\xE1ximo de 100 s\xEDmbolos";
        ...
        _createClass(LoginComponent, [{
          ...
          value: function initForm() {
            this.loginForm = this.fb.group({
              ...
              password: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(3), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(100)])]
            });
          }
        }, {
          key: "submit",
          value: function submit() {
            ...
            this.hasError = false; // const loginSubscr = this.authService
            ...
            this.authService.login(this.f.email.value, this.f.password.value).subscribe(function (resp) {
              console.log(resp); // this.router.navigate(['/dashboard']);
      ...
      LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 32,
        vars: 41,
        consts: [[1, "login-form", "login-signin"], ["novalidate", "novalidate", "id", "kt_login_signin_form", 1, "form", 3, "formGroup", "ngSubmit"], [1, "pb-13", "pt-lg-0", "pt-5"], [1, "font-weight-bolder", "text-dark", "font-size-h4", "font-size-h1-lg"], [4, "ngIf"], [1, "form-group"], [1, "font-size-h6", "font-weight-bolder", "text-dark"], ["type", "email", "name", "email", "formControlName", "email", 1, "form-control", "form-control-solid", "h-auto", "py-7", "px-6", "rounded-lg", 3, "ngClass"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "d-flex", "justify-content-between", "mt-n5"], [1, "font-size-h6", "font-weight-bolder", "text-dark", "pt-5"], ["type", "password", "name", "password", "autocomplete", "off", "formControlName", "password", 1, "form-control", "form-control-solid", "h-auto", "py-7", "px-6", "rounded-lg", 3, "ngClass"], [1, "pb-lg-0", "pb-5"], ["type", "submit", "id", "kt_login_signin_submit", 1, "btn", "btn-primary", "font-weight-bolder", "font-size-h6", "px-8", "py-4", "my-3", "mr-3", 3, "disabled"], ["formError", ""], [1, "mb-10", "alert", "alert-custom", "alert-light-info", "alert-dismissible"], [1, "alert-text"], [1, "mb-10", "alert", "alert-custom", "alert-light-danger", "alert-dismissible"], [1, "spinner", "spinner-primary", "ml-5"], [1, "fv-plugins-message-container"], [1, "fv-help-block"]],
        template: function LoginComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](20, "Contrase\xF1a");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](27, " Iniciar sesi\xF3n ");
    ...
    function NRzN(module, __webpack_exports__, __webpack_require__) {
      ...
      AuthComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 15,
        vars: 0,
        consts: [["id", "kt_login_wrapper", 1, "d-flex", "flex-column", "flex-root", "h-100"], ["id", "kt_login", 1, "login", "login-1", "login-signin-on", "d-flex", "flex-column", "flex-lg-row", "flex-column-fluid", "bg-white"], [1, "login-aside", "d-flex", "flex-column", "flex-row-auto", 2, "background-color", "#00236D"], [1, "d-flex", "flex-column-auto", "flex-column", "pt-lg-40", "pt-15"], ["href", "#", 1, "text-center", "mb-10"], ["src", "./assets/media/logos/logo.png", "alt", "", 1, "max-h-70px"], [1, "font-weight-bolder", "text-center", "font-size-h4", "font-size-h1-lg", 2, "color", "#E4FDE1"], [1, "aside-img", "d-flex", "flex-row-fluid", "bgi-no-repeat", "bgi-position-y-bottom", "bgi-position-x-center", 2, "background-image", "url('./assets/media/svg/illustrations/login-visual-1.svg')"], [1, "login-content", "flex-row-fluid", "d-flex", "flex-column", "justify-content-center", "position-relative", "overflow-hidden", "p-7", "mx-auto"], [1, "d-flex", "flex-column-fluid", "flex-center"], [1, "d-flex", "justify-content-lg-start", "justify-content-center", "align-items-end", "py-7", "py-lg-0"]],
    ...
    function SiHH(module, __webpack_exports__, __webpack_require__) {
      ...
      function ForgotPasswordComponent_ng_container_7_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "El correo est\xE1 incorrecto");
      ...
      var ForgotPasswordComponent = /*#__PURE__*/function () {
        ...
        _createClass(ForgotPasswordComponent, [{
          ...
          key: "submit",
          value: function submit() {
            this.errorState = ErrorStates.NotSubmitted; // const forgotPasswordSubscr = this.authService
      ...
      ForgotPasswordComponent.ɵfac = function ForgotPasswordComponent_Factory(t) {
        return new (t || ForgotPasswordComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]));
      };
      ...
      ForgotPasswordComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function ForgotPasswordComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, " \xBFOlvidaste tu contrase\xF1a? ");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "p", 4);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, " Ingresa tu correo para crear contrase\xF1a nueva ");
