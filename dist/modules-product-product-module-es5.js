(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-product-product-module"], {
    ...
    /***/
    function AZlN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DeleteGaleriaImagenComponent", function () {
        return DeleteGaleriaImagenComponent;
      });
      /* harmony import */
      ...
      var DeleteGaleriaImagenComponent = /*#__PURE__*/function () {
        function DeleteGaleriaImagenComponent(modal, productoService, toaster) {
          _classCallCheck(this, DeleteGaleriaImagenComponent);
        ...
        _createClass(DeleteGaleriaImagenComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "delete",
          value: function _delete() {
            ...
            this.productoService.deleteGaleria(data).subscribe(function (resp) {
              console.log(resp);
      ...
      DeleteGaleriaImagenComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function DeleteGaleriaImagenComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DeleteGaleriaImagenComponent_Template_button_click_11_listener() {
              return ctx["delete"]();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DeleteGaleriaImagenComponent_Template_button_click_13_listener() {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DeleteGaleriaImagenComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
    ...
    /***/
    function F3IH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _categories_services_categories_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../categories/_services/categories.service */
      "ASgP");
      /* harmony import */
      ...
      function AddNewProductComponent_ng_container_36_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
      ...
      function AddNewProductComponent_div_61_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AddNewProductComponent_tr_92_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddNewProductComponent_tr_92_Template_button_click_4_listener() {
      ...
      var AddNewProductComponent = /*#__PURE__*/function () {
        function AddNewProductComponent(_productService, _categorieService, toaster) {
        ...
        _createClass(AddNewProductComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this._categorieService.allCategories().subscribe(function (resp) {
              console.log(resp);
          ...
          value: function loadServices() {
            ...
            setTimeout(function () {
              _this3._productService.isLoadingSubject.next(false);
            }, 50);
          }
        }, {
          key: "processFile",
          value: function processFile($event) {
            ...
            reader.onloadend = function () {
              return _this4.imagen_previzualizacion = reader.result;
            };
          ...
          value: function save() {
            ...
            if (!this.title || !this.categorie || !this.price_pesos || !this.price_usd || !this.resumen || !this.description || !this.sku || this.tags.length == 0 || !this.imagen_file) {
              this.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                text: "danger-'Upps! NECESITAS DIGITAR TODOS LOS CAMPOS DEL FORMULARIO.'"
              });
              return;
            }
            ...
            this._productService.createProduct(formData).subscribe(function (resp) {
              console.log(resp);

              if (resp.code == 403) {
                _this5.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                  text: "danger-'UPPS ! EL PRODUCTO YA EXISTE, DIGITAR OTRO NOMBRE'"
                });

                return;
              } else {
                _this5.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                  text: "primary-'EL PRODUCTO SE REGISTRO CON EXITO'"
                });

                _this5.title = null;
                _this5.categorie = null;
                _this5.sku = null;
                _this5.price_pesos = null;
                _this5.price_usd = null;
                _this5.description = null;
                _this5.resumen = null;
                _this5.tags = [];
                _this5.imagen_file = null;
                _this5.imagen_previzualizacion = null;
                return;
              }
            });
          }
      ...
      AddNewProductComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 96,
        vars: 18,
        consts: [[1, "card", "card-custom", "gutter-b"], [1, "card-header"], [1, "card-title"], [1, "card-label"], [1, "icon-2x", "text-dark-50", "flaticon-imac", "mx-2"], [1, "card-toolbar"], [1, "card-body"], [4, "ngIf"], [1, "form-group", "row"], [1, "col-6"], [1, "form-group"], [1, "text-danger"], ["type", "text", "placeholder", "", "name", "title", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "form-text", "text-muted"], [1, "col-3"], ["type", "text", "placeholder", "", "name", "sku", 1, "form-control", 3, "ngModel", "ngModelChange"], ["name", "categorie", 1, "form-control", 3, "ngModel", "ngModelChange"], ["value", ""], [4, "ngFor", "ngForOf"], ["type", "text", "placeholder", "", "name", "price_pesos", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "text", "placeholder", "", "name", "price_usd", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "col-4"], [1, "form-label"], [1, "custom-file"], ["type", "file", "id", "customFile", "accept", ".jpeg, .bmp, .jpg, .png, .gif, .webp", 1, "custom-file-input", 3, "change"], ["for", "customFile", 1, "custom-file-label"], ["class", "", 4, "ngIf"], ["name", "resumen", "placeholder", "", "rows", "4", 1, "form-control", 3, "ngModel", "ngModelChange"], [3, "ngModel", "init", "ngModelChange"], [1, "col-6", "d-flex", "align-items-center"], ["type", "text", "placeholder", "", "name", "tag", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "btn", "btn-primary", "mx-2", 3, "click"], [1, "table-responsive"], ["id", "kt_advance_table_widget_1", 1, "table", "table-head-custom", "table-vertical-center"], [1, "text-left"], [1, "btn", "btn-primary", 3, "click"], [1, "spinner", "spinner-primary", "ml-5"], [3, "value"], [1, ""], ["alt", "", "srcset", "", 2, "width", "150px", 3, "src"], [1, "btn", "btn-danger", 3, "click"]],
        template: function AddNewProductComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddNewProductComponent_Template_input_ngModelChange_26_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddNewProductComponent_Template_select_ngModelChange_33_listener($event) {
              return ctx.categorie = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](41, "PRECIO MXN: ");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddNewProductComponent_Template_input_ngModelChange_44_listener($event) {
              return ctx.price_pesos = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddNewProductComponent_Template_input_ngModelChange_51_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function AddNewProductComponent_Template_input_change_57_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddNewProductComponent_Template_textarea_ngModelChange_66_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](69, "Descripci\xF3n: *");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](70, "editor", 28);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddNewProductComponent_Template_editor_ngModelChange_70_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddNewProductComponent_Template_input_ngModelChange_78_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](90, "ACCI\xD3N");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddNewProductComponent_Template_button_click_94_listener() {
              return ctx.save();
            });
          ...
          if (rf & 2) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngModel", ctx.price_pesos);
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AddNewProductComponent, [{
          ...
          return [{
            ...
            type: _categories_services_categories_service__WEBPACK_IMPORTED_MODULE_3__["CategoriesService"]
          }, {
            type: ngx_toast_notifications__WEBPACK_IMPORTED_MODULE_4__["Toaster"]
          }];
        }, null);
    ...
    /***/
    function H9Dl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DeleteNewProductComponent", function () {
        return DeleteNewProductComponent;
      });
      /* harmony import */
      ...
      var DeleteNewProductComponent = /*#__PURE__*/function () {
        function DeleteNewProductComponent(modal, productoService, toaster) {
          _classCallCheck(this, DeleteNewProductComponent);
        ...
        _createClass(DeleteNewProductComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "delete",
          value: function _delete() {
            ...
            this.productoService.deleteProduct(this.product._id).subscribe(function (resp) {
              console.log(resp);

              _this6.ProductD.emit("");
      ...
      DeleteNewProductComponent.ɵfac = function DeleteNewProductComponent_Factory(t) {
        return new (t || DeleteNewProductComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_product_service__WEBPACK_IMPORTED_MODULE_3__["ProductService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_toast_notifications__WEBPACK_IMPORTED_MODULE_4__["Toaster"]));
      };

      DeleteNewProductComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: DeleteNewProductComponent,
        selectors: [["app-delete-new-product"]],
        inputs: {
          product: "product"
        },
        outputs: {
        ...
        vars: 2,
        consts: [[1, "modal-content"], [1, "modal-header"], ["id", "example-modal-sizes-title-lg", 1, "modal-title", "h4"], [1, "icon-2x", "text-dark-50", "flaticon-user-add", "mx-2"], [1, "overlay", "overlay-block", "cursor-default", "modal-body"], [1, "row"], [1, "col-12"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-danger", "btn-elevate", "mr-2", 3, "click"], ["type", "button", 1, "btn", "btn-light", "btn-elevate", "mr-2", 3, "click"]],
        template: function DeleteNewProductComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DeleteNewProductComponent_Template_button_click_11_listener() {
              return ctx["delete"]();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DeleteNewProductComponent_Template_button_click_13_listener() {
              return ctx.modal.dismiss();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DeleteNewProductComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
    ...
    /***/
    function aD6I(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DeleteNewVariedadComponent", function () {
        return DeleteNewVariedadComponent;
      });
      /* harmony import */
      ...
      var DeleteNewVariedadComponent = /*#__PURE__*/function () {
        function DeleteNewVariedadComponent(modal, productoService, toaster) {
          _classCallCheck(this, DeleteNewVariedadComponent);
        ...
        _createClass(DeleteNewVariedadComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "delete",
          value: function _delete() {
            ...
            this.productoService.deleteVariedad(this.variedad._id).subscribe(function (resp) {
              console.log(resp);

              _this7.VariedadD.emit("");
      ...
      DeleteNewVariedadComponent.ɵfac = function DeleteNewVariedadComponent_Factory(t) {
        return new (t || DeleteNewVariedadComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_product_service__WEBPACK_IMPORTED_MODULE_3__["ProductService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_toast_notifications__WEBPACK_IMPORTED_MODULE_4__["Toaster"]));
      };

      DeleteNewVariedadComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: DeleteNewVariedadComponent,
        selectors: [["app-delete-new-variedad"]],
        inputs: {
          variedad: "variedad"
        },
        outputs: {
        ...
        vars: 2,
        consts: [[1, "modal-content"], [1, "modal-header"], ["id", "example-modal-sizes-title-lg", 1, "modal-title", "h4"], [1, "icon-2x", "text-dark-50", "flaticon-user-add", "mx-2"], [1, "overlay", "overlay-block", "cursor-default", "modal-body"], [1, "row"], [1, "col-12"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-danger", "btn-elevate", "mr-2", 3, "click"], ["type", "button", 1, "btn", "btn-light", "btn-elevate", "mr-2", 3, "click"]],
        template: function DeleteNewVariedadComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DeleteNewVariedadComponent_Template_button_click_11_listener() {
              return ctx["delete"]();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DeleteNewVariedadComponent_Template_button_click_13_listener() {
              return ctx.modal.dismiss();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DeleteNewVariedadComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
    ...
    function fB2i(module, __webpack_exports__, __webpack_require__) {
      ...
      var EditorComponent = /*#__PURE__*/function (_Events) {
        ...
        function EditorComponent(elementRef, ngZone, platformId, tinymceScriptSrc) {
          ...
          _this8.platformId = platformId;
          _this8.tinymceScriptSrc = tinymceScriptSrc;
          _this8.cloudChannel = '5';
          _this8.apiKey = 'no-api-key';
          _this8.id = '';
          _this8.modelEvents = 'change input undo redo';
          _this8.onTouchedCallback = noop;
          _this8._elementRef = elementRef;
          _this8.ngZone = ngZone;
          _this8.initialise = _this8.initialise.bind(_assertThisInitialized(_this8));
          return _this8;
        }
          ...
          value: function initialise() {
            ...
            var finalInit = Object.assign(Object.assign({}, this.init), {
              ...
              setup: function setup(editor) {
                _this9._editor = editor;
                editor.on('init', function (_e) {
                  _this9.initEditor(editor);
                });
                bindHandlers(_this9, editor);

                if (_this9.init && typeof _this9.init.setup === 'function') {
                  _this9.init.setup(editor);
                }
              }
            });
          ...
          value: function initEditor(editor) {
            ...
            editor.on('blur', function () {
              return _this10.ngZone.run(function () {
                return _this10.onTouchedCallback();
              });
            });
            editor.on(this.modelEvents, function () {
              return _this10.ngZone.run(function () {
                return _this10.emitOnChange(editor);
              });
            });

            if (typeof this.initialValue === 'string') {
              this.ngZone.run(function () {
                editor.setContent(_this10.initialValue);

                if (editor.getContent() !== _this10.initialValue) {
                  _this10.emitOnChange(editor);
                }

                if (_this10.onInitNgModel !== undefined) {
                  _this10.onInitNgModel.emit(editor);
                }
              });
            }
          }
    ...
    /***/
    function gcdm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EditNewProductComponent", function () {
        return EditNewProductComponent;
      });
      /* harmony import */
      ...
      var _delete_galeria_imagen_delete_galeria_imagen_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../delete-galeria-imagen/delete-galeria-imagen.component */
      "AZlN");
      /* harmony import */


      var _variedades_delete_new_variedad_delete_new_variedad_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../variedades/delete-new-variedad/delete-new-variedad.component */
      "aD6I");
      /* harmony import */


      var _variedades_edit_new_variedad_edit_new_variedad_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../variedades/edit-new-variedad/edit-new-variedad.component */
      "pU42");
      /* harmony import */
      ...
      var _categories_services_categories_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../categories/_services/categories.service */
      "ASgP");
      /* harmony import */
      ...
      function EditNewProductComponent_ng_container_8_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
      ...
      function EditNewProductComponent_ng_container_36_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
      ...
      function EditNewProductComponent_div_73_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditNewProductComponent_tr_104_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewProductComponent_tr_104_Template_button_click_4_listener() {
            ...
            return ctx_r11.removeTag(i_r10);
          });
      ...
      function EditNewProductComponent_div_121_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 49);
      ...
      function EditNewProductComponent_tr_135_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewProductComponent_tr_135_Template_button_click_4_listener() {
            ...
            return ctx_r15.removeImagen(item_r13);
          });
      ...
      function EditNewProductComponent_div_153_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_div_153_Template_input_ngModelChange_6_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r18);

            var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r17.stock = $event;
          });
      ...
      function EditNewProductComponent_div_154_tr_32_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewProductComponent_div_154_tr_32_Template_a_click_6_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r22);

            var variedad_r20 = ctx.$implicit;

            var ctx_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

            return ctx_r21.editVariedad(variedad_r20);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewProductComponent_div_154_tr_32_Template_a_click_13_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r22);
            ...
            return ctx_r23.deleteVariedad(variedad_r20);
          });
      ...
      function EditNewProductComponent_div_154_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_div_154_Template_input_ngModelChange_8_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r25);

            var ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r24.valor_multiple = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_div_154_Template_input_ngModelChange_15_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r25);

            var ctx_r26 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r26.stock_multiple = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewProductComponent_div_154_Template_button_click_17_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r25);

            var ctx_r27 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r27.saveVariedad();
          });
      ...
      var EditNewProductComponent = /*#__PURE__*/function () {
        function EditNewProductComponent(_productService, router, _categorieService, activeRouter, toaster, modalService) {
          _classCallCheck(this, EditNewProductComponent);
        ...
        _createClass(EditNewProductComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this11 = this;
            ...
            this.activeRouter.params.subscribe(function (resp) {
              console.log(resp);
              _this11.product_id = resp.id;
            });

            this._productService.showProduct(this.product_id).subscribe(function (resp) {
              console.log(resp);
              _this11.product_selected = resp.product;
              _this11.title = _this11.product_selected.title;
              _this11.sku = _this11.product_selected.sku;
              _this11.categorie = _this11.product_selected.categorie._id;
              _this11.price_pesos = _this11.product_selected.price_pesos;
              _this11.price_usd = _this11.product_selected.price_usd;
              _this11.stock = _this11.product_selected.stock;
              _this11.imagen_previzualizacion = _this11.product_selected.imagen;
              _this11.resumen = _this11.product_selected.resumen;
              _this11.description = _this11.product_selected.description;
              _this11.tags = _this11.product_selected.tags;
              _this11.variedades = _this11.product_selected.variedades;
              _this11.type_inventario = _this11.product_selected.type_inventario;
              _this11.state = _this11.product_selected.state;
              _this11.galerias = _this11.product_selected.galerias;
            });

            this._categorieService.allCategories().subscribe(function (resp) {
              console.log(resp);
              _this11.categories = resp.categories;

              _this11.loadServices();
            });
          }
        }, {
          key: "loadServices",
          value: function loadServices() {
            ...
            setTimeout(function () {
              _this12._productService.isLoadingSubject.next(false);
            }, 50);
          }
        }, {
          key: "processFile",
          value: function processFile($event) {
            ...
            reader.onloadend = function () {
              return _this13.imagen_previzualizacion = reader.result;
            };

            this.loadServices();
          }
        }, {
          key: "processFileGaleria",
          value: function processFileGaleria($event) {
            var _this14 = this;
            ...
            reader.onloadend = function () {
              return _this14.imagen_previz_galeria = reader.result;
            };
          ...
          value: function update() {
            ...
            if (!this.title || !this.categorie || !this.price_pesos || !this.price_usd || !this.resumen || !this.description || !this.sku || this.tags.length == 0) {
              this.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                text: "danger-'Upps! NECESITAS DIGITAR TODOS LOS CAMPOS DEL FORMULARIO.'"
              });
              return;
            ...
            this._productService.updateProduct(formData).subscribe(function (resp) {
              console.log(resp);
              ...
              if (resp.code == 403) {
                ...
                _this15.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                  text: "primary-'EL PRODUCTO SE HA EDITADO CON EXITO'"
                });

                _this15.router.navigateByUrl("/productos/lista-de-todos-los-productos");
          ...
          key: "checkedInventario",
          value: function checkedInventario(value) {
            this.type_inventario = value;
          }
        }, {
          key: "saveVariedad",
          value: function saveVariedad() {
            var _this16 = this;

            if (!this.valor_multiple || !this.stock_multiple) {
              this.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                text: "danger-'ES NECESARIO DIGITAR UN VALOR Y UNA CANTIDAD'"
              });
              return;
            }
            ...
            this._productService.createVariedad(data).subscribe(function (resp) {
              console.log(resp);
              _this16.valor_multiple = null;
              _this16.stock_multiple = null;

              var index = _this16.variedades.findIndex(function (item) {
                return item._id == resp.variedad._id;
              });

              if (index != -1) {
                _this16.variedades[index] = resp.variedad;
                ...
                _this16.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                  text: "primary-'LA VARIEDAD SE EDITO CORRECTAMENTE'"
                });
              } else {
                _this16.variedades.unshift(resp.variedad);

                _this16.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                  text: "primary-'LA VARIEDAD SE REGISTRO CORRECTAMENTE'"
                });
              }
            });
          }
          ...
          key: "editVariedad",
          value: function editVariedad(variedad) {
            var _this17 = this;

            var modalRef = this.modalService.open(_variedades_edit_new_variedad_edit_new_variedad_component__WEBPACK_IMPORTED_MODULE_4__["EditNewVariedadComponent"], {
              centered: true,
              size: 'sm'
            });
            modalRef.componentInstance.variedad = variedad;
            modalRef.componentInstance.VariedadE.subscribe(function (variedadE) {
              var index = _this17.variedades.findIndex(function (item) {
                return item._id == variedadE._id;
              });

              if (index != -1) {
                _this17.variedades[index] = variedadE;

                _this17.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                  text: "primary-'LA VARIEDAD SE EDITO CORRECTAMENTE'"
                });
              }
            });
          ...
          key: "deleteVariedad",
          value: function deleteVariedad(variedad) {
            var _this18 = this;

            var modalRef = this.modalService.open(_variedades_delete_new_variedad_delete_new_variedad_component__WEBPACK_IMPORTED_MODULE_3__["DeleteNewVariedadComponent"], {
              centered: true,
              size: 'sm'
            });
            modalRef.componentInstance.variedad = variedad;
            modalRef.componentInstance.VariedadD.subscribe(function (resp) {
              var index = _this18.variedades.findIndex(function (item) {
                return item._id == variedad._id;
              });

              if (index != -1) {
                _this18.variedades.splice(index, 1);

                _this18.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                  text: "primary-'LA VARIEDAD SE ELIMINO CORRECTAMENTE'"
                });
              }
            });
          }
          ...
          key: "storeImagen",
          value: function storeImagen() {
            var _this19 = this;

            if (!this.imagen_file_galeria) {
              this.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                text: "danger-'NECESITAS SELECCIONAR UNA IMAGEN'"
              });
              return;
            }
            ...
            this._productService.createGaleria(formData).subscribe(function (resp) {
              console.log(resp);
              _this19.imagen_file_galeria = null;
              _this19.imagen_previz_galeria = null;

              _this19.galerias.unshift(resp.imagen);
            });
          }
        }, {
          key: "removeImagen",
          value: function removeImagen(imagen) {
            var _this20 = this;

            var modalRef = this.modalService.open(_delete_galeria_imagen_delete_galeria_imagen_component__WEBPACK_IMPORTED_MODULE_2__["DeleteGaleriaImagenComponent"], {
              centered: true,
              size: 'sm'
            });
            modalRef.componentInstance.imagen = imagen;
            modalRef.componentInstance.product_id = this.product_id;
            modalRef.componentInstance.ImagenD.subscribe(function (resp) {
              var index = _this20.galerias.findIndex(function (item) {
                return item._id == imagen._id;
              });

              if (index != -1) {
                _this20.galerias.splice(index, 1);

                _this20.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                  text: "primary-'LA IMAGEN SE ELIMINO CORRECTAMENTE'"
                });
              }
            });
          }
      ...
      EditNewProductComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function EditNewProductComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_Template_input_ngModelChange_17_listener($event) {
              return ctx.title = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_Template_input_ngModelChange_26_listener($event) {
              return ctx.sku = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_Template_select_ngModelChange_33_listener($event) {
              return ctx.categorie = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_Template_input_ngModelChange_44_listener($event) {
              return ctx.price_pesos = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_Template_input_ngModelChange_51_listener($event) {
              return ctx.price_usd = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_Template_select_ngModelChange_57_listener($event) {
              return ctx.state = $event;
            });

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](58, "option", 22);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](59, "DESARROLLO");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function EditNewProductComponent_Template_input_change_69_listener($event) {
              return ctx.processFile($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_Template_textarea_ngModelChange_78_listener($event) {
              return ctx.resumen = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](81, "Descripci\xF3n: *");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](82, "editor", 32);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_Template_editor_ngModelChange_82_listener($event) {
              return ctx.description = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewProductComponent_Template_input_ngModelChange_90_listener($event) {
              return ctx.tag = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewProductComponent_Template_button_click_92_listener() {
              return ctx.addTag();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function EditNewProductComponent_Template_input_change_117_listener($event) {
              return ctx.processFileGaleria($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewProductComponent_Template_button_click_123_listener() {
              return ctx.storeImagen();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](133, "ACCI\xD3N");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewProductComponent_Template_input_click_143_listener() {
              return ctx.checkedInventario(1);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewProductComponent_Template_input_click_147_listener() {
              return ctx.checkedInventario(2);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewProductComponent_Template_button_click_156_listener() {
              return ctx.update();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewProductComponent_Template_button_click_158_listener() {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EditNewProductComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
          ...
          return [{
            ...
            type: _categories_services_categories_service__WEBPACK_IMPORTED_MODULE_7__["CategoriesService"]
          }, {
            type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"]
          }, {
            type: ngx_toast_notifications__WEBPACK_IMPORTED_MODULE_8__["Toaster"]
          }, {
    ...
    /***/
    function hB3u(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _delete_new_product_delete_new_product_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../delete-new-product/delete-new-product.component */
      "H9Dl");
      /* harmony import */
      ...
      function ListProductsComponent_ng_container_25_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
      ...
      function ListProductsComponent_tr_58_span_14_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 43);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "DESARROLLO");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        }
      }

      function ListProductsComponent_tr_58_span_15_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ListProductsComponent_tr_58_span_16_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ListProductsComponent_tr_58_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListProductsComponent_tr_58_Template_a_click_18_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListProductsComponent_tr_58_Template_a_click_25_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9);
            ...
            return ctx_r10["delete"](product_r4);
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("", product_r4.price_pesos, " MXN");
      ...
      var ListProductsComponent = /*#__PURE__*/function () {
        function ListProductsComponent(_productService, router, modalService, toaster, _categorieService) {
        ...
        _createClass(ListProductsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this._categorieService.allCategories().subscribe(function (resp) {
              console.log(resp);
              _this21.categories = resp.categories;

              _this21.loadServices();
            });
          }
        }, {
          key: "loadServices",
          value: function loadServices() {
            ...
            setTimeout(function () {
              _this22._productService.isLoadingSubject.next(false);
            }, 50);
          }
        }, {
          key: "allProducts",
          value: function allProducts() {
            ...
            this._productService.allProducts(this.search, this.categorie).subscribe(function (resp) {
              console.log(resp);
              _this23.products = resp.products;
            });
          }
        }, {
          key: "refresh",
          ...
          value: function _delete(product) {
            ...
            var modalRef = this.modalService.open(_delete_new_product_delete_new_product_component__WEBPACK_IMPORTED_MODULE_2__["DeleteNewProductComponent"], {
              centered: true,
              size: 'sm'
            });
            modalRef.componentInstance.product = product;
            modalRef.componentInstance.ProductD.subscribe(function (resp) {
              var index = _this24.products.findIndex(function (item) {
                return item._id == product._id;
              });

              if (index != -1) {
                _this24.products.splice(index, 1);

                _this24.toaster.open(src_app_componets_notifications_noticy_alert_noticy_alert_component__WEBPACK_IMPORTED_MODULE_1__["NoticyAlertComponent"], {
                  text: "primary-'EL PRODUCTO SE ELIMINO CORRECTAMENTE'"
                });
              }
            });
          }
      ...
      ListProductsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function ListProductsComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListProductsComponent_Template_input_ngModelChange_16_listener($event) {
              return ctx.search = $event;
            })("keyup.enter", function ListProductsComponent_Template_input_keyup_enter_16_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListProductsComponent_Template_select_ngModelChange_22_listener($event) {
              return ctx.categorie = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListProductsComponent_Template_button_click_31_listener() {
              return ctx.allProducts();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListProductsComponent_Template_button_click_33_listener() {
              return ctx.refresh();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](50, "PRECIO MXN");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](56, "ACCI\xD3N");
    ...
    /***/
    function iARD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _edit_new_product_edit_new_product_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./edit-new-product/edit-new-product.component */
      "gcdm");
      /* harmony import */
    ...
    /***/
    function pU42(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EditNewVariedadComponent", function () {
        return EditNewVariedadComponent;
      });
      /* harmony import */
      ...
      function EditNewVariedadComponent_ng_container_6_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
      ...
      var EditNewVariedadComponent = /*#__PURE__*/function () {
        function EditNewVariedadComponent(modal, _serviceProduct) {
          _classCallCheck(this, EditNewVariedadComponent);
        ...
        _createClass(EditNewVariedadComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
          ...
          value: function update() {
            ...
            this._serviceProduct.updateVariedad(data).subscribe(function (resp) {
              console.log(resp);

              _this25.VariedadE.emit(resp.variedad);
      ...
      EditNewVariedadComponent.ɵfac = function EditNewVariedadComponent_Factory(t) {
        return new (t || EditNewVariedadComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbActiveModal"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_product_service__WEBPACK_IMPORTED_MODULE_2__["ProductService"]));
      };

      EditNewVariedadComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: EditNewVariedadComponent,
        selectors: [["app-edit-new-variedad"]],
        inputs: {
          variedad: "variedad"
        },
        outputs: {
        ...
        template: function EditNewVariedadComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditNewVariedadComponent_Template_input_ngModelChange_15_listener($event) {
              return ctx.variedad_multiple = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewVariedadComponent_Template_button_click_19_listener() {
              return ctx.update();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditNewVariedadComponent_Template_button_click_21_listener() {
              return ctx.modal.dismiss();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EditNewVariedadComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
    ...
    /***/
    function qKt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ProductService = /*#__PURE__*/function () {
        ...
        _createClass(ProductService, [{
          ...
          value: function allProducts() {
            ...
            var categorie = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
            ...
            var URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/products/list" + LINK;
            return this.http.get(URL, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
              return _this26.isLoadingSubject.next(false);
            }));
          }
        }, {
          key: "showProduct",
          value: function showProduct() {
            ...
            var product_id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
            this.isLoadingSubject.next(true);
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]({
              'token': this.authservice.token
            });
            var URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/products/show/" + product_id;
            return this.http.get(URL, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
              return _this27.isLoadingSubject.next(false);
            }));
          }
        }, {
          key: "createProduct",
          value: function createProduct(data) {
            ...
            var URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/products/register";
            return this.http.post(URL, data, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
              return _this28.isLoadingSubject.next(false);
            }));
          }
        }, {
          key: "updateProduct",
          value: function updateProduct(data) {
            ...
            var URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/products/update";
            return this.http.put(URL, data, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
              return _this29.isLoadingSubject.next(false);
            }));
          }
        }, {
          key: "deleteProduct",
          value: function deleteProduct(product_id) {
            var _this30 = this;
            ...
            var URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/products/delete?_id=" + product_id;
            return this.http["delete"](URL, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
              return _this30.isLoadingSubject.next(false);
            }));
          } // galeria

        }, {
          key: "createGaleria",
          value: function createGaleria(data) {
            var _this31 = this;
            ...
            var URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/products/register_imagen";
            return this.http.post(URL, data, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
              return _this31.isLoadingSubject.next(false);
            }));
          }
        }, {
          key: "deleteGaleria",
          value: function deleteGaleria(data) {
            var _this32 = this;
            ...
            var URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/products/remove_imagen";
            return this.http.post(URL, data, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
              return _this32.isLoadingSubject.next(false);
            }));
          } // variedad

        }, {
          key: "createVariedad",
          value: function createVariedad(data) {
            var _this33 = this;
            ...
            var URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/products/register-variedad";
            return this.http.post(URL, data, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
              return _this33.isLoadingSubject.next(false);
            }));
          }
        }, {
          key: "updateVariedad",
          value: function updateVariedad(data) {
            var _this34 = this;
            ...
            var URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/products/update-variedad";
            return this.http.put(URL, data, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
              return _this34.isLoadingSubject.next(false);
            }));
          }
        }, {
          key: "deleteVariedad",
          value: function deleteVariedad(variedad_id) {
            var _this35 = this;
            ...
            var URL = src_app_config_config__WEBPACK_IMPORTED_MODULE_4__["URL_SERVICIOS"] + "/products/delete-variedad/" + variedad_id;
            return this.http["delete"](URL, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
              return _this35.isLoadingSubject.next(false);
            }));
          }
        }]);
      ...
      ProductService.ɵfac = function ProductService_Factory(t) {
        return new (t || ProductService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_auth__WEBPACK_IMPORTED_MODULE_5__["AuthService"]));
      };
    ...
    /***/
    function sjYV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _edit_new_product_edit_new_product_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./edit-new-product/edit-new-product.component */
      "gcdm");
      /* harmony import */


      var _delete_new_product_delete_new_product_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./delete-new-product/delete-new-product.component */
      "H9Dl");
      /* harmony import */
      ...
      var _variedades_edit_new_variedad_edit_new_variedad_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./variedades/edit-new-variedad/edit-new-variedad.component */
      "pU42");
      /* harmony import */


      var _variedades_delete_new_variedad_delete_new_variedad_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./variedades/delete-new-variedad/delete-new-variedad.component */
      "aD6I");
      /* harmony import */


      var _delete_galeria_imagen_delete_galeria_imagen_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./delete-galeria-imagen/delete-galeria-imagen.component */
      "AZlN");
      ...
      ProductModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _product_routing_module__WEBPACK_IMPORTED_MODULE_2__["ProductRoutingModule"], // 
...
//# sourceMappingURL=modules-product-product-module-es5.js.map